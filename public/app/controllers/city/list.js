angular.module('myApp').controller('ListCityController', ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'NavigationService', 'EntityUtilService', 'CityService', function($http, $scope, $location, $q, $timeout, $modal, NavigationService, EntityUtilService, CityService) {
	...
	$scope.edit = function (obj) {
		$location.path('/city/edit/' + obj._id);
	};
	$scope.view = function (obj) {
		$location.path('/city/view/' + obj._id);
	};
	$scope.delete = function (obj) {
		$location.path('/city/delete/' + obj._id);
	};
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(CityService, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(CityService, $scope.dataList, $scope.refresh);  
	}
